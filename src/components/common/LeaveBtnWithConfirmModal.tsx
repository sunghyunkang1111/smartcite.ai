...
type LeaveBtnWithConfirmModalProps = {
  onDelete: () => void;
  trigger: ReactNode;
};

const LeaveBtnWithConfirmModal = ({ onDelete, trigger }: LeaveBtnWithConfirmModalProps) => {
...
export default LeaveBtnWithConfirmModal;
